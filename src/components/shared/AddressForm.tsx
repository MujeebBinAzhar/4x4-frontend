...
function AddressForm(props: Props) {
    ...
    return (
        <React.Fragment>
            ...
            <div className="form-group">
                <label htmlFor={`${fieldId}suburb`}>
                    <FormattedMessage id="Suburb" />
                </label>
                <input
                    type="text"
                    id={`${fieldId}suburb`}
                    className={classNames('form-control', {
                        'is-invalid': errors?.suburb,
                    })}
                    disabled={disabled}
                    placeholder={intl.formatMessage({ id: 'INPUT_CITY_PLACEHOLDER' })}
                    {...register(`${ns}suburb`, { required: true })}
                />
                <div className="invalid-feedback">
                    {errors?.suburb?.type === 'required' && <FormattedMessage id="ERROR_FORM_REQUIRED" />}
                </div>
            </div>
            <div className="form-group">
                ...
                >
                    <option value="">{intl.formatMessage({ id: 'INPUT_STATE_PLACEHOLDER' })}</option>
                    {[
                        'New South Wales',
                        'Victoria',
                        'Queensland',
