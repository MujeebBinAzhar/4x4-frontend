...
function AddressCard(props: Props) {
    const { address, label, featured = false, loading = false, className, footer, ...rootProps } = props;
    ...
    return (
        <div className={rootClasses} {...rootProps}>
            ...
            {label && <div className="address-card__badge tag-badge tag-badge--theme">{label}</div>}
            ...
            <div className="address-card__body">
                ...
                {footer && <div className="address-card__footer">{footer}</div>}
            </div>
        </div>
    );
}
