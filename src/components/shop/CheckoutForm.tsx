...
// import DeliveryForm from '../shared/DeliveryMethodForm';
...
function CheckoutForm() {
    ...
    const { ref: shipToDifferentAddressCheckboxRef, ...shipToDifferentAddressCheckboxProps } =
    ...
    return (
        <React.Fragment>
            ...
            <div className="form-group d-block">
                <AddressForm namespace="billingAddress" idPrefix="checkout-billing-address" />
            </div>
