                            ...
                            <div className="category-card__content">
                                <div className="category-card__info">
                                    <div className="category-card__name">
                                        <AppLink href={url.shopCategoryProduct(category)}>{category.name}</AppLink>
                                    </div>
                                    <ul className="category-card__children">
                                        {subs.map((sub, subIdx) => (
                                            <li key={subIdx}>
                                                <AppLink href={url.shopCategoryProduct(sub)}>{sub.name}</AppLink>
                                            </li>
                                        ))}
                                    </ul>
                                    <div className="category-card__actions">
                                        <AppLink
                                            href={url.shopCategoryProduct(category)}
                                ...
                                <AppSlick className="block-zone__carousel-slick" ref={slickRef} {...slickSettings}>
                                    {products.map((product) => (
                                        <div key={product.id} className="block-zone__carousel-item">
                                            <ProductCard product={product} exclude={excludeElements} />
                                        </div>
                                    ))}
                                </AppSlick>
                            </div>
