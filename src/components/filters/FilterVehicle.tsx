                ...
                <ul className="filter-vehicle__list">
                    <li className="filter-vehicle__item">
                        ...
                        <label className="filter-vehicle__item-label">
                            <Checkbox className="filter-list__input" checked={value !== null} onChange={handleChange} />
                    ...
                    <li className="filter-vehicle__vehicle">
                        ...
                        <div className="filter-vehicle__vehicle-subtitle">{currentVehicle.engine}</div>
                    </li>
                </ul>
            )}
            {currentVehicle === null && (
