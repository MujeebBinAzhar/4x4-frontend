...
export type IProductStock = 'in-stock' | 'out-of-stock' | 'on-backorder' | 'low-stock' | 'high-stock';
...
export type IProductsList = ISortableList<IProduct> & INavigableList<IProduct> & IFilterableList<IProduct>;
