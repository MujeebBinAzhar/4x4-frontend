...
import FreeLayout from '~/components/account/FreeLayout';
...
function Page() {
    ...
    return (
        <React.Fragment>
            <PageTitle title="Custom Builds" metaTitle="Add Custom Build" />

            <BlockSpace layout="spaceship-ledge-height" />

            <div className="container container--max--xl">
                <div className="faq__header">
                    <h1 className="faq__header-title">Add Build</h1>
                </div>
