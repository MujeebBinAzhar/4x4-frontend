...
function Page() {
    ...
    const { list, options, onNavigate } = useList((options) => accountApi.getOrdersList({ limit: 5, ...options, email: user?.email || '' }));
            ...
            {list && (
                <React.Fragment>
                    ...
                    <div className="card-footer">
                        <Navigation data={list.navigation} page={options.page} onNavigate={onNavigate} />
                    </div>
                </React.Fragment>
            )}
        </div>
