...
import { IDesktopHeaderLayout, IDesktopHeaderScheme, IOptionsData, IOptionsState } from '~/store/options/optionsTypes';
...
function optionsSetAll(state: IOptionsState, options: IOptionsData): IOptionsState {
    ...
    const [desktopHeaderLayout, desktopHeaderScheme] = desktopHeaderVariant.split('/') as [
