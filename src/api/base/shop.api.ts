...
import { IProduct, IProductsList, ISeo } from '~/interfaces/product';
...
export abstract class ShopApi {
    abstract getPageSeo(slug: string): Promise<ISeo>;
    ...
    abstract checkout(data: ICheckoutData): Promise<string>;
}
